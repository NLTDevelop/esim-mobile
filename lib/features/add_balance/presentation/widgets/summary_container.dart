              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    DefaultText.displaySmall('\$ ${state.paymentValue.toStringAsFixed(2)}', color: Theme.of(context).extension<ColorExtension>()!.text,),
                  ],
                ),
                Padding(
                  ...
                  child: DashedDivider(
                    height: 1,
                    color: Theme.of(context).extension<ColorExtension>()!.hintText,
                  ),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    DefaultText.bodySmall('Payable', color: Theme.of(context).extension<ColorExtension>()!.text,),
                    DefaultText.bodySmall('\$ ${state.paymentValue.toStringAsFixed(2)}', color: Theme.of(context).extension<ColorExtension>()!.text,),
                  ],
                ),
              ],
            ),
