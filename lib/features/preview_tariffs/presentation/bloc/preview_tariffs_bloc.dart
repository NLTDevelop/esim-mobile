...
class PreviewTariffsBloc
  ...
  void _onFetchTariffs(_PreviewTariffsEventFetchTariffs event, Emitter<PreviewTariffsState> emit){
    ...
    const List<TariffModel> tariffs = [
      TariffModel(dataInGB: 1, price: 2.49, durationInDays: 7),
      TariffModel(dataInGB: 3, price: 10.49, durationInDays: 30),
      TariffModel(dataInGB: 5, price: 19.49, durationInDays: 30),
      TariffModel(dataInGB: 50, price: 95.99, durationInDays: 90),
    ];
