      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: SearchWidget(
              onChange: context.read<StoreBloc>().onChangeSearchText,
            ),
          ),
          Expanded(
                    ...
                    Row(
                      children: [
                        PrimarySwitcherButton(
                          ...
                          onTap: () {
                            bloc.add(
                              const StoreEvent.changePlansType(isLocal: true),
                            );
                          },
                        ...
                        PrimarySwitcherButton(
                          ...
                          onTap: () {
                            bloc.add(
                              const StoreEvent.changePlansType(isLocal: false),
                            );
                          },
                          isActive: !state.isLocal,
                        ),
                            ...
                            child: ListView.separated(
                              itemBuilder: (context, index) {
                                return StoreDataCard(
                                  name: state.isLocal
                                      ? state.countryModels[index].name
                                      : state.regionModels[index].name,
                                  price: state.isLocal
                                      ? state.countryModels[index].prices
                                            .firstWhereOrNull(
                                              (e) =>
                                                  e.currency ==
                                                  (s.user.currencyCode ??
                                            ...
                                            ?.amount
                                      : state.regionModels[index].prices
                                            .firstWhereOrNull(
                                              (e) =>
                                                  e.currency ==
                                                  (s.user.currencyCode ??
                                  ...
                                  sign: s.user.currencyCode == null
                                      ? '\$'
                                      : s.user.currencyCode == 'USD'
                                      ? '\$'
                                      : '€',
                                  code: state.isLocal
                                      ? state.countryModels[index].code
                                      : null,
                                  onTap: () {
                                    ...
                                    context.push(
                                      Routes.tariffs,
                                      extra: {
                                        'country_entity': state.isLocal
                                            ? state.countryModels[index]
                                            : state.regionModels[index],
                                        'is_from_welcome': bloc.isFromWelcome,
                                      },
                                    );
                                  },
                                );
                              ...
                              itemCount: state.isLocal
                                  ? state.countryModels.length
                                  : state.regionModels.length,
                              shrinkWrap: true,
                            ),
                          ),
                        );
