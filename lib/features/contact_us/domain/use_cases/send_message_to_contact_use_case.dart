...
class SendMessageToContactUseCase extends UseCase<void , MessageParams>{

  const SendMessageToContactUseCase({required ContactRepository contactRepository}) : _contactRepository = contactRepository;
