          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                ... context.read<InstallESimCubit>().userESims.asMap().entries.map((e) => Padding(padding: const EdgeInsets.only(bottom: 10), child: Bounce(
                  duration: const Duration(milliseconds: 300),
                  onPressed: (){
                    context.read<InstallESimCubit>().chooseESim(e.key);
                  },
                  child: Container(
                    padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 16),
                    decoration: BoxDecoration(
                    ...
                    SvgPicture.network(
                      'https://myaccount.keepgo.com/img/flags/3x2/${e.value.country.toLowerCase()}.svg', width: 22, height: 16,),
                        ...
                        Container(
                          ...
                          child: DefaultText.labelSmall(e.value.status == 'PENDING' ? 'not installed' : e.value.status == 'ACTIVE' ? 'installed' : 'used'),
                        ),
                        const Spacer(),
                        Container(
                          width: 20,
